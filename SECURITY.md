...
Use **Command -> Settings -> About -> Private Security Report** or GitHub private vulnerability reporting instead:
...
See [Privacy](https://galbutnotgirl.github.io/command/privacy.html) for local file locations, diagnostics, clipboard history, dictation data, background logs, and export safety.

For the in-app support buttons, diagnostics, and reporting actions, see [Settings Reference](https://galbutnotgirl.github.io/command/settings.html). Repo/offline copies are bundled in [docs/PRIVACY.md](docs/PRIVACY.md) and [docs/SETTINGS_REFERENCE.md](docs/SETTINGS_REFERENCE.md).
